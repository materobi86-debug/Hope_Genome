...
Write-Host " Building Zcode Launchpad Mini MK3 Windows 11 Executable " -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
...
Write-Host "  1. zcode-launchpad-tray.exe    (System Tray app with icon)" -ForegroundColor Yellow
Write-Host "  2. zcode-launchpad-daemon.exe  (Background daemon)" -ForegroundColor Yellow
Write-Host "  3. zcode-launchpad-notify.exe  (CLI hook notifier)" -ForegroundColor Yellow
